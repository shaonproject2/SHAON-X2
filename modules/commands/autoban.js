...
module.exports.handleEvent = async ({
	...
	const i = require("moment-timezone").tz("Asia/Dhaka").format("hh:mm:ss");
	if (s == t.getCurrentUserID()) return;
	let c = await n.getNameUser(o.senderID);
    //Edit your answer
	var h = {
		body: `»এডমিন এর পক্ষ থেকে নোটিশ«\n\n${c} তুমি খারাপ কমান্ড আমার বস SHAON 卝 চৌধুরীヅ এর কাছ থেকে অনুমতি নিয়ে দেও নাই তাই তোমাকে আমি বেন করে দিলাম যাতে তুমি বট চালাতে না পারো`
	};
    //Add curse words without capital letters
	["baler bot", "@SHAON 卝 চৌধুরীヅ baler bot tor", "bot vlo na", "ki baler bot", "Bot cudi", "@SHAON 卝 চৌধুরীヅ cudi tora", "Lol bot", "tor boss ra cudi", "বটকে চুদি", "bot k kick de", "kick daw bot", "baler bot k kick daw", "fuck you bot", "fuck me bot", "bot fuck you", "/sexvideo", "/sex video", "sex", "crazy bots", "bobo bot", "bot dở", "bot khùng", "đĩ bot", "bot paylac rồi", "con bot lòn", "cmm bot", "clap bot", "bot ncc", "bot oc", "bot óc", "bot óc chó", "cc bot", "bot tiki", "lozz bottt", "lol bot", "loz bot", "lồn bot", "bot lồn", "bot lon", "bot cac", "bot nhu lon", "bot như cc", "bot như bìu", "Bot sida", "bot sida", "bot fuck", "Bảo ngu", "bot shoppee", "bad bots", "bot cau"].forEach((a => {
