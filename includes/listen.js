...
(async function () {
    ...
    if (!data.includes(event.threadID) && !adminBot.includes(event.senderID)) {
      ...
      if (event.body && event.body == `${prefix}request`) {
        ...
        return api.sendMessage(`😘আমার বস শাওন আহমেদ এর কাছে রিকোয়েস্ট পাঠিয়ে দেও হয়েছে....🍂🌸`, event.threadID);
      }
      if (event.body && event.body.startsWith(prefix)) return api.sendMessage(`🌿আপনাদের গ্রুপে পারমিশন নাই🌿\n\n 🖤পারমিশন করাতে আমার বস কে নক দিন আর না হয় 👉${prefix}request 👈 এই কমান্ড দেও এডমিন এর কাছে নোটিশ চলে যাবে\n\n 💝🥀𝐎𝐖𝐍𝐄𝐑:- ☞🌺✰𝗦𝗛𝗔𝗢𝗡 𝗔𝗛𝗠𝗘𝗗★🌺☜ 💫\n
🖤𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 〠SHAON AHMED

😳𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐢𝐝🤓:- ☞ https://www.facebook.com/Hey.Its.Me.Shaon.Ahmed

📑 গ্রুপে পারমিশন না পেলে আমার বস কে গ্ৰুপে এড করুন💖\n
👋For Any Kind Of Help Contact On মেসেঞ্জার  Username 👉m.me/Hey.Its.Me.Shaon.Ahmed😇`, event.threadID);
    };
    switch (event.type) {
      case "message":
      case "message_reply":
